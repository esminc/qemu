...
#else
void  control_control_write( ControlClient  client, const char*  buff, int  len )
#endif
{
    int ret;
...
#ifdef TODO
#else
extern void goldfish_usbgadget_test(void *p, char *arg);
#endif
static int
...
#ifndef TODO
	control_write( client, "hello! this is tmori. good bye. args=%s\n", 
		(args == NULL)?"NULL":args );
	goldfish_usbgadget_test((void*)client, args);
#else
    if (!args) {
